return {
  {
    ...
    config = function()
      ...
      -- 🔄 Cycle through tabs
      vim.keymap.set('n', '<C-h>', ':BufferLineCyclePrev<CR>', { noremap = true, silent = true, desc = '🔄 Previous tab' })
      vim.keymap.set('n', '<C-l>', ':BufferLineCycleNext<CR>', { noremap = true, silent = true, desc = '🔄 Next tab' })
      ...
      vim.keymap.set('n', '<C-g>', ':BufferLineMovePrev<CR>',
